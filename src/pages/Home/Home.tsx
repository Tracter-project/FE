        ...
        <div className={styles.first}>
          ...
          <div className={styles.firstSecText}>
            ...
            <p className={styles.TextP}>
              ...
              호텔에서 이용해 보세요. 휴식 및 재충전을 위해 사우나에서 시간을
              보내보세요. 시설 내 커피숍인 illy CAFFE에서 브런치, 가벼운 식사도
              즐기실 수 있습니다. 모든 고객은 객실 내 무료 WiFi, 커피숍/카페,
              드라이클리닝/세탁 서비스 등을 이용하실 수 있습니다.
            </p>
        ...
        <div className={styles.travelPic}>
          <div className={styles.content}>
            ...
            <Title size="p">
              ...
              <br /> 호캉스, 글램핑, 풀빌라, 캠핑, 카라반에 관한 정보를 제공
              해드립니다.
            </Title>
